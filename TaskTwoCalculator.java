...
Developing a Java console-based calculator application capable of performing basic
arithmetic operations such as addition, subtraction, multiplication, and
division. Users input two numbers and select an operation, and the calculator
displays the result. The application should handle invalid inputs and division by
zero gracefully.
 */
